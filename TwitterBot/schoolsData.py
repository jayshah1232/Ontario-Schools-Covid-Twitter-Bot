...
for record in currentData: #for loop to retrieve the current data for the day
    if record['_id'] == currentMax: #currently set to a hard number as the data API by the government was released today with some issues
